...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        print(f"{county_name}: {county_percentage:.1f}% ({co_votes:,})\n")

        county_results = (f"{county_name}: {county_percentage:.1f}% ({co_votes:,})\n")
        ...
        if (co_votes > largest_county_count) and (county_percentage > largest_county_percentage):
            #set largest county output=county name
            largest_county_count = co_votes
    ...
    for candidate_name in candidate_votes:
        ...
        #move candidate results to text file
